...
final class SettingsViewController: UIViewController {
    ...
    private lazy var logoutButton = UIButton.logoutButton(withTarget: self, action: #selector(logoutTapped))
...
private extension UIButton {
    static func logoutButton(withTarget target: Any, action: Selector) -> UIButton {
